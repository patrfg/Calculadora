...
const Calculadora = require('../scr/calculadora'); // Importa a classe Calculadora criada em 'src/calculadora.js'.
...
describe('Calculadora', function () {
    ...
    describe('dividir', function () {
        ...
        it('deve lançar um erro quando dividir por zero', function () {
            ...
            */
            assert.throws(() => calc.dividir(7, 1), /Divisão por zero não é permitida\./);
        });
    });
});